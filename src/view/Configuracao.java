...
public class Configuracao extends javax.swing.JFrame {
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        configuracao.setProperty("ip", this.jTextFieldIP.getText());
        configuracao.setProperty("porta", this.jTextFieldPorta.getText());
        configuracao.setProperty("usuario", this.jTextFieldUsuario.getText());
        try {
